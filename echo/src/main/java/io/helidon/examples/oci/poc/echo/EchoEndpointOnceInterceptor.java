 ...
 * {@link EchoEndpoint#once(String, String)}.
 */
@SuppressWarnings("deprecation")
@Service.Singleton
class EchoEndpointOnceInterceptor implements HttpEntryPoint.Interceptor {
    ...
    private static final ElementSignature ELEMENT_SIGNATURE = ElementSignature.createMethod(
            STRING_TYPENAME, "once", List.of(STRING_TYPENAME, STRING_TYPENAME));
