 ...
 */
public class OciExtensionProvider implements RegistryCodegenExtensionProvider {
     ...
     */
    @Deprecated
    public OciExtensionProvider() {
    }

    @Override
    public Set<TypeName> supportedAnnotations() {
        return Set.of(OciTypes.AUTHORIZED_ANNOTATION);
    }

    @Override
    public RegistryCodegenExtension create(RegistryCodegenContext codegenContext) {
        return new OciExtension(codegenContext);
    }
}
